...
if (isset($_GET['id'])) {
    ...
    if ($res->num_rows == 1) {
        ...
        header('Location: manage-dermatology.php');
        exit();
    }
} else {
    header('Location: manage-dermatology.php');
...
if (isset($_POST['submit'])) {
    ...
    if ($stmt->execute()) {
        // Redirect to manage-dermatology programs page
        header('Location: manage-dermatology.php?status=success&action=update_program');
        exit();
    } else {
