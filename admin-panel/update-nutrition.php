...
if (isset($_GET['id'])) {
    ...
    if ($res->num_rows == 1) {
        ...
        header('Location: manage-nutration.php');
        exit();
    }
} else {
    header('Location: manage-nutration.php');
...
if (isset($_POST['submit'])) {
    ...
    if ($stmt->execute()) {
        ...
        header('Location: manage-nutration.php?status=success&action=update_program');
        exit();
    } else {
...
<div class="main-content">
    <div class="wrapper">
        <h1 class="text-center">Update Nutrition Program</h1>
