    ...
    <div class="wrapper">
        ...
        <form action="" method="POST" class="dropdown-form">
            <select name="file-select" class="styled-select" onchange="location = this.value;">
                ...
                <option value="manage-laboratory.php"selected>Manage Testing</option>
        ...
        <a href="add-program.php" class="btn-primary">Add Testing</a>
        <br><br>

        <div class="programs-grid">
            <?php
            // Fetch nutrition programs from tbl_programs
            $sql = "SELECT * FROM tbl_programs WHERE category_id = (SELECT id FROM tbl_programCategories WHERE title = 'Laboratory Service')";
            $res = $conn->query($sql);
            ...
            ?>
                    ...
                    <div class="program-box">
                        ...
                        <div class="program-actions">
                            <a href="update-laboratory.php?id=<?php echo $program_id; ?>" class="btn-secondary">Update</a>
