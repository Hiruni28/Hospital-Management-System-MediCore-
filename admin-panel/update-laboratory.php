...
if (isset($_GET['id'])) {
    ...
    if ($res->num_rows == 1) {
        ...
        header('Location: manage-laboratory.php');
        exit();
    }
} else {
    header('Location: manage-laboratory.php');
...
if (isset($_POST['submit'])) {
    ...
    if ($stmt->execute()) {
        // Redirect to manage-laboratory programs page
        header('Location: manage-laboratory.php?status=success&action=update_program');
        exit();
    } else {
...
<div class="main-content">
    <div class="wrapper">
        <h1 class="text-center">Update laboratory</h1>
