...
if (isset($_GET['id'])) {
    ...
    if ($res->num_rows == 1) {
        ...
        header('Location: manage-neurology.php');
        exit();
    }
} else {
    header('Location: manage-neurology.php');
...
if (isset($_POST['submit'])) {
    ...
    if ($stmt->execute()) {
        // Redirect to manage-neurology programs page
        header('Location: manage-neurology.php?status=success&action=update_program');
        exit();
    } else {
...
<div class="main-content">
    <div class="wrapper">
        <h1 class="text-center">Update Neurology</h1>
