...
<div class="main-content">
    <div class="wrapper">
        <h1 class="text-center">OPD/ETU</h1>
        ...
        <form action="" method="POST" class="dropdown-form">
            <select name="file-select" class="styled-select" onchange="location = this.value;">
                ...
                <option value="manage-nutration.php"selected>Manage OPD/ETU</option>
        ...
        <a href="add-program.php" class="btn-primary">Add OPD/ETU</a>
        <br><br>

        <div class="programs-grid">
            <?php
            // Fetch nutrition programs from tbl_programs
            $sql = "SELECT * FROM tbl_programs WHERE category_id = (SELECT id FROM tbl_programCategories WHERE title = 'OPD/ETU')";
            $res = $conn->query($sql);
