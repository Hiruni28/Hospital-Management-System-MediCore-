...
<div class="main-content">
    <div class="wrapper">
        <h1 class="text-center">Specialist Consultation</h1>
        ...
        <form action="" method="POST" class="dropdown-form">
            <select name="file-select" class="styled-select" onchange="location = this.value;">
                ...
                <option value="manage-consultation.php"selected>Manage Consultation</option>
        ...
        <a href="add-program.php" class="btn-primary">Add Consultation</a>
        <br><br>

        <div class="programs-grid">
            <?php
            // Fetch nutrition programs from tbl_programs
            $sql = "SELECT * FROM tbl_programs WHERE category_id = (SELECT id FROM tbl_programCategories WHERE title = 'Specialist Consultation')";
            $res = $conn->query($sql);
            ...
            ?>
                    ...
                    <div class="program-box">
                        ...
                        <div class="program-actions">
                            <a href="update-consultation.php?id=<?php echo $program_id; ?>" class="btn-secondary">Update</a>
