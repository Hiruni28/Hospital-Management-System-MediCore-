...
if (isset($_GET['id'])) {
    ...
    if ($res->num_rows == 1) {
        ...
        header('Location: manage-orthopedics.php');
        exit();
    }
} else {
    header('Location: manage-orthopedics.php');
...
if (isset($_POST['submit'])) {
    ...
    if ($stmt->execute()) {
        // Redirect to manage-orthopedics programs page
        header('Location: manage-orthopedics.php?status=success&action=update_program');
        exit();
    } else {
        echo "<div class='error'>Failed to update the dental program. Please try again.</div>";
    }
}
?>
...
<div class="main-content">
    <div class="wrapper">
        <h1 class="text-center">Update Orthopedics</h1>
