...
<div class="main-content">
    <div class="wrapper">
        <h1 class="text-center">Operation Theatre</h1>
        ...
        <form action="" method="POST" class="dropdown-form">
            <select name="file-select" class="styled-select" onchange="location = this.value;">
                ...
                <option value="manage-classProgram.php"selected>Manage Operation</option>
        ...
        <a href="add-program.php" class="btn-primary">Add Operation</a>
        <br><br>

        <div class="programs-grid">
            <?php
            $sql = "SELECT * FROM tbl_programs WHERE category_id = (SELECT id FROM tbl_programCategories WHERE title = 'Operation Theatre')";
            $res = $conn->query($sql);
